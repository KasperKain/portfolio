...
const About: React.FC = () => {
  return (
    <SectionContainer titleBar={<TitleBar text='About Me' />}>
      <BaseBox>
        <TextBox
          text="Hey there! I'm Patrick, though some folks know me as Kasper. I comfortably wear multiple hats: Developer, Designer, Creator, and whatever else I feel like doing in the moment. My journey through technology and design has led me to work on some exciting projects. 
